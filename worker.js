...
function defaultCompetitors() {
  return {
    omar:  { name:'King Omar',  ai:'Claude Pro',             revenue:0, color:'#6366f1', emoji:'👑', github:'kingomarwashere',
      project:{ domain:'chuckasickie.org', site:'https://makeamillyoritsembarassing.theradicalparty.com', repo:'https://github.com/Bored-investments/chuckasickie', repoSlug:'Bored-investments/chuckasickie', commitsToday:3, totalCommits:42, openPrs:0, mergedPrs:0, latestCommits:['f280051 Add hello@chuckasickie.org contact email to footer','934818c Update Microsoft Clarity tag ID','8400358 Add Tawk.to live chat widget','a4beec4 Add auto-deploy to Cloudflare Pages','f499855 Add Meta Pixel Purchase event, pharmacist trust signals, FAQ section'], idea:'AutoContent AI — done-for-you social media and email content for small businesses.', focus:'Drive first paying customers through warm outreach, X/Twitter, and Reddit.' } },
